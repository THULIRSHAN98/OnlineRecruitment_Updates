...
namespace pro.Controllers.Admin
{
    ...
    public class SkillUserController : ControllerBase
    {
        ...
        public async Task<ActionResult> AddUserToSkill(JsonObject skillUserDTO)
        {
            ...
            //var skill = await _context.Skills.FirstOrDefaultAsync(s => s.SkillName == skillUserDTO.SkillName);
            //if (skill == null)
            //{
